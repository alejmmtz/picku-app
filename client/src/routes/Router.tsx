...
import ConsumerLogin from "../pages/auth/consumer/ConsumerLogin";
import ConsumerSignup from "../pages/auth/consumer/ConsumerSignup";
import MyOrders from "../pages/consumer/orders/MyOrders";
import OrderDetails from "../pages/consumer/orders/OrderDetails";
import EntrepreneurLogin from "../pages/auth/entrepreneur/EntrepreneurLogin";
import EntrepreneurSignup from "../pages/auth/entrepreneur/EntrepreneurSignup";
