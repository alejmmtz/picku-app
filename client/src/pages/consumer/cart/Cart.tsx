      ...
      <section className="app-screen pb-32">
        ...
        {cartItems.length === 0 && (
          <div className="rounded-[16px] px-6 py-53 text-center">
            ...
            <p className="mt-2 font-light text-[15px] text-black/60">
        ...
        <div className="flex flex-col gap-5">
          {cartItems.map((item) => (
            <article
              key={item.product.id}
              className="rounded-[16px] border border-black/15 p-4"
            >
              <div className="flex gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-[16px] font-light text-black/60">
        ...
        <div className="fixed bottom-0 left-1/2 w-full max-w-[430px] -translate-x-1/2 rounded-t-[18px] bg-white px-12 py-7 shadow-[0_-8px_30px_rgba(0,0,0,0.05)]">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className={`h-[50px] rounded-xl px-9 text-[16px] font-light text-white ${
                cartItems.length === 0
